...
//       const response = await axios.post(`${(process.env.NODE_ENV === 'development' ? 'http://localhost:3001/' : 'vino-rojo-restaurant-production.up.railway.app')}login/update/${id}`, data);
