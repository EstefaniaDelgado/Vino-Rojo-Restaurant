...
function Forgetpassword() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      swal(
        '¡LISTO!',
        'Te hemos enviado un correo para restablecer tu contraseña, recuerda que tienes 20 mins para realizar este cambio.',
        'success'
      ) && history('/login');
    } catch (error) {
      swal({
        ...
        <div className="container1">
          <div className="col-right1">
            <div className="login-form1">
              ...
              <p>
                Por favor, diligencie su correo electronico con el cual se
                registro en VinoRojo Bodegón, para así, restablecer su
                contraseña.
              </p>
              <br />
              <div>
